...
LOG_FILE: {{ .Values.api.logFile | quote }}
LOG_FILE_MAX_SIZE: {{ .Values.api.logFileMaxSize | quote }}
LOG_FILE_BACKUP_COUNT: {{ .Values.api.logFileBackupCount | quote }}
LOG_DATEFORMAT: {{ .Values.api.logDateformat | quote }}
LOG_TZ: {{ .Values.api.logTz | quote }}
